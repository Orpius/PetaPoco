...
namespace PetaPoco
{
    ...
    public interface IExecute
    {
        ...
        T ExecuteScalar<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T>(Sql sql);
        ...
        /// <returns>The scalar result value of type <typeparamref name="T"/>.</returns>
        T ExecuteScalar<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T>(string sql, params object[] args);
    }
}
