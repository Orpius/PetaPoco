...
namespace PetaPoco
{
#if ASYNC
    /// <summary>
    /// Specifies a set of methods for asynchronously executing SQL queries and returning the result set as lists, enumerables, single
    /// POCOs, multi-POCOs, or paged results.
    /// </summary>
    public interface IQueryAsync
    {
        ...
        /// on each result read from the underlying data reader.
        /// </summary>
        /// <remarks>
        /// <see cref="IDatabase.EnableAutoSelect"/> must be enabled in order to generate the auto-select portion of the SQL statement.
        /// </remarks>
        ...
        /// returns the results as a list of type <typeparamref name="T"/>.
        /// </summary>
        /// <remarks>
        /// <see cref="IDatabase.EnableAutoSelect"/> must be enabled in order to generate the auto-select portion of the SQL statement.
        /// <para/>This method performs essentially the same operation as <see cref="SkipTakeAsync{T}(CancellationToken, long, long)"/>.
        /// Determining the number of records to skip, and how many to take, however, are calculated automatically based on the specified
        /// <paramref name="page"/> index and <paramref name="maxItemsPerPage"/> values.
        /// </remarks>
        /// <typeparam name="T">The POCO type representing a single result record.</typeparam>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
        ...
        /// </summary>
        /// <remarks>
        /// This method performs essentially the same operation as <see cref="SkipTakeAsync{T}(CancellationToken, long, long, string,
        /// object[])"/>. Determining the number of records to skip, and how many to take, however, are calculated automatically based on
        /// the specified <paramref name="page"/> index and <paramref name="maxItemsPerPage"/> values.
        /// </remarks>
        /// <typeparam name="T">The POCO type representing a single result record.</typeparam>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
        /// <param name="page">The one-based page number used to calculate the number of records to skip.</param>
        ...
        /// <summary>
        /// Asynchronously executes an auto-select query (<c>SELECT *</c>) for a subset of records based on the specified parameters, and
        /// returns the results as a Page of type <typeparamref name="T"/>.
        /// </summary>
        /// <remarks>
        /// <see cref="IDatabase.EnableAutoSelect"/> must be enabled in order to generate the auto-select portion of the SQL statement.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// If provided a POCO object as the <paramref name="pocoOrPrimaryKeyValue"/> parameter, PetaPoco will extract the value from the
        ...
        /// empty; this method throws an exception if there is more than one matching record.
        /// </summary>
        /// <typeparam name="T">The POCO type representing a single result record.</typeparam>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
        /// <param name="primaryKey">The primary key value.</param>
        /// <returns>
        /// A task that represents the asynchronous operation. The task result contains default(T) if no record is found; otherwise, the
        ...
        /// method throws an exception if there is more than one matching record.
        /// </summary>
        /// <typeparam name="T">The POCO type representing a single result record.</typeparam>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
        /// <param name="sql">The SQL query string.</param>
