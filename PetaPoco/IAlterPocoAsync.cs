...
namespace PetaPoco
{
    ...
    public interface IAlterPocoAsync
    {
        ...
        /// <returns>
        /// A task that represents the asynchronous operation. The task result contains the primary key of the new record if the table has a
        /// primary key column; otherwise, <see langword="null"/>.
        /// </returns>
        ...
        /// <summary>
        /// Asynchronously updates the specified columns of a record with the given ID and returns the number of rows affected by the update
        /// operation.
        /// </summary>
        /// <inheritdoc cref="UpdateAsync(CancellationToken, string, string, object, object, IEnumerable{string})"/>
        ...
        /// <summary>
        /// Asynchronously updates the specified columns of a record in the provided table and returns the number of rows affected by the
        /// update operation.
        /// </summary>
        /// <inheritdoc cref="UpdateAsync(CancellationToken, string, string, object, object, IEnumerable{string})"/>
        ...
        /// <summary>
        /// Asynchronously updates the specified columns of a record with the given ID in the provided table and returns the number of rows
        ...
        /// <summary>
        /// Asynchronously deletes a record with the given ID from the provided table and returns the number of rows affected by the delete
        /// operation.
        /// </summary>
        /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
        /// <param name="tableName">The name of the table containing the record to delete.</param>
        ...
        /// <remarks>
        /// Performs an <see cref="InsertAsync(object)"/> operation if the POCO is new (as determined by <see
        /// cref="IAlterPoco.IsNew(object)"/>), and an <see cref="UpdateAsync(object)"/> operation otherwise.
        ...
        /// </summary>
        /// <remarks>
        /// Performs an <see cref="InsertAsync(string, string, object)"/> operation if the POCO is new (as determined by <see
        /// cref="IAlterPoco.IsNew(string, object)"/>), and an <see cref="UpdateAsync(string, string, object)"/> operation otherwise.
